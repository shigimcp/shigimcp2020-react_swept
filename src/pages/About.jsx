...
function disperseChildren(parentContainer) {
    ...
    let minAngleDegrees = -170;
    let maxAngleDegrees = -10;
    ...
    return (
        ...
        <div className='aboutContainer' id='aboutContainerID' ref={aboutContainer_Ref}>
            ...
            <div className='haiku'>
                ...
                <p className='plea'>(This is not even haiku... someone, *please* take her crayon away!)</p>
            </div>

            <div className='afroContainer' id='afroContainerID' ref={afroContainer_Ref}>
